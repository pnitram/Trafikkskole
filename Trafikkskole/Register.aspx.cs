...
namespace Trafikkskole
{
    public partial class Register : Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            _bekreftetPassordHash = HashPasswordForStoringInConfigFile(_passord, "MD5"); // just for fun --> not safe
            ...
            try
            {
                using (MySqlConnection con = new MySqlConnection(_myconnectionstring))
                {
                    ...
                    {
                        _sql =
                            $"INSERT INTO users(firstName, lastName, email, password) VALUES(\'{_fornavn}\',\'{_etternavn}\',\'{_epost}\',\'{_bekreftetPassordHash}\')";
                        cmd.CommandText = _sql;
                        cmd.ExecuteNonQuery();
